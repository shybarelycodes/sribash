  ...
  try {
    ...
    gallery.innerHTML = `
      <div class="empty">
        ...
        <p>Check that gallery.json exists and is valid JSON.</p>
      </div>
    `;
  }
}
...
function renderGallery(photos) {
  ...
  photos.forEach((photo, index) => {
    ...
    article.setAttribute("aria-label", `Open image: ${photo.title}`);
    ...
    article.innerHTML = `
      ...
      <div class="card__body">
        <h3 class="card__title">${escapeHtml(photo.title)}</h3>
